...
/**
 * Yêu cầu tạo tin đăng mới (LIST-01/LIST-02, docs/03 mục 4.4.7).
 *
 * <p>Độ dài tiêu đề/mô tả được kiểm tra lại ở tầng service theo {@code SystemConfig}
 * ({@code listing.title.*}, {@code listing.description.*}); các ràng buộc {@code @Size} ở đây là
 * hàng rào tối đa an toàn, không thay thế ngưỡng cấu hình động.
 */
@Getter
@Setter
@Builder
...
public class ListingCreateRequest {
    ...
    /** {@code true} → tạo nháp rồi gửi duyệt ngay (LIST-02); mặc định chỉ lưu nháp (LIST-01). */

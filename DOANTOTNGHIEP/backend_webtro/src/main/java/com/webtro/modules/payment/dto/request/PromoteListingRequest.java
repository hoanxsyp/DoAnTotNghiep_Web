...
/**
 * Yêu cầu mua gói đẩy tin theo đường tắt — {@code POST /api/listings/{id}/promote} (canonical 4.9.4).
 * {@code listingId} lấy từ path; đây là alias ngữ nghĩa của {@link CreatePaymentRequest}.
 */
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "PromoteListingRequest", description = "Yêu cầu mua gói đẩy tin (đường tắt)")
